 ...
 * 02111-1307, USA.
 */
#ifndef _TAGGERDATATRIGRAM_
#define _TAGGERDATATRIGRAM_
...
private:
  ...
  void copy(TaggerDataTrigram const &o);
  void destroy();
public:
  TaggerDataTrigram();
  virtual ~TaggerDataTrigram();
  TaggerDataTrigram(TaggerDataTrigram const &o);
